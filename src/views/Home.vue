<template>
    <div id="Solution" class="font">
        ...
        <div class="about">
            <h3>ABOUT US</h3>
            <p>
                Uptima is on a mission to help businesses in the oil and gas sector in Africa
                realize their full potential through innovative software and hardware solutions. We
                are presently a leading provider of hardware and on-demand cloud computing solutions
                for remote Monitoring of tanks and tankers within the oil and gas industry.
            </p>
        </div>
        ...
        <div class="images">
            ...
            <img src="../assets/images/png/pic2.png" alt="pic2" />
            <img src="../assets/images/png/pic3.png" alt="pic3" />
            <img src="../assets/images/png/pic4.png" alt="pic4" />
            <img src="../assets/images/png/pic5.png" alt="pic5" />
        </div>
        <div class="help">
            <div class="help-text">
                ...
                <div class="light-blue-bg">
                    <div class="grow">
                        ...
                        <p>
                            ...
                            on your fuel consumption rates
                        </p>
                        <router-link to="#"
                            >FIND OUT MORE
                            <svg
